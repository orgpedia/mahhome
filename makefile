...
import/websites/gr.maharashtra.gov.in/Home:
	cd import/websites/gr.maharashtra.gov.in/ && ln -s $(GR_DIR)/Home .
...
import: check_env import/websites/gr.maharashtra.gov.in/Home .secrets/google.token 
	poetry run python import/src/build_documents.py import/websites/gr.maharashtra.gov.in/Home import/documents
